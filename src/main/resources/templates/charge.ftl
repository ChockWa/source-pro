...
<#--                <div style="margin-top: 10px;"><a href="#" style="color: #009688;">&ndash;&gt;点击此处购买官方卡号</a></div>-->
<#--            </div>-->
<#--        </div>-->
<#--    </form>-->
<#--    <div class="button_area">-->
<#--        <button id="submitCharge" type="button" class="layui-btn layui-btn">确 定</button>-->
<#--        &lt;#&ndash;        <button type="button" class="layui-btn layui-btn-primary layui-btn">取消</button>&ndash;&gt;-->
<#--    </div>-->
<#--</div>-->
